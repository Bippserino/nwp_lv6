...
router.route("/edit/:id")
  ...
  .put(async function (req, res) {
    try {
      ...
      let updatedProject = await mongoose.model("Project").findByIdAndUpdate(
        req.params.id,
        {
          projectName,
          projectDescription,
      ...
      res.status(500).send("There was a problem updating the information to the database: " + err);
    }
  })
  ...
  .delete(async function (req, res) {
    try {
      ...
      res.status(500).send("There was a problem deleting the project: " + err);
    }
  });
